                ...
                <div class="dt-brand">
                    ...
                    <span class="dt-brand__logo">
                        <a class="dt-brand__logo-link" href="{{route('home')}}">
                            <img class="d-sm-inline-block" width="150" src="{{asset('assets/img/logo/logo.png')}}"
                                alt="{{config('app.name')}}">
                        </a>
                    </span>
                    <!-- /brand logo -->
                            ...
                            <li class="dt-nav__item dropdown">
                                ...
                                <a href="#" class="dt-nav__link dropdown-toggle no-arrow dt-avatar-wrapper"
                                    ...
                                    <span class="dt-avatar-info d-none d-sm-block">
                                        <span class="dt-avatar-name"> {{ Auth::user()->name }} <i
                                                class="icon icon-chevrolet-down icon-fw icon-lg"></i></span>
                                    </span> </a>
                                <!-- /dropdown link -->
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" href="javascript:void(0)"> <i
                                            class="icon icon-user icon-fw mr-2 mr-sm-1"></i>Profile
            ...
            <aside id="main-sidebar" class="dt-sidebar">
                <div class="dt-sidebar__container">
                    ...
                    <ul class="dt-side-nav">
                        ...
                        <li class="dt-side-nav__item {{ (request()->segment(1) == 'packages') ? 'selected' : '' }}">
                            <a href="{{route('packages.index')}}" class="dt-side-nav__link" title="User Management">
                                <i class="icon icon-layout icon-fw icon-lg"></i>
                                <span class="dt-side-nav__text">Package Management</span>
                            </a>
                        </li>

                        <li class="dt-side-nav__item {{ (request()->segment(1) == 'themes') ? 'selected' : '' }}">
                            <a href="{{route('themes.index')}}" class="dt-side-nav__link" title="User Management">
                                <i class="icon icon-layout icon-fw icon-lg"></i>
                                <span class="dt-side-nav__text">Theme Management</span>
                            </a>
                        </li>
                        ...
                        <li class="dt-side-nav__item">
                            <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="">
                                ...
                                <span class="dt-side-nav__text">Setup</span>
                            </a>

                            <!-- Sub-menu -->
                            <ul class="dt-side-nav__sub-menu">
                                <li
                                    class="dt-side-nav__item {{ (request()->segment(2) == 'categories') ? 'selected' : '' }}">
                                    <a href="{{route('category.index')}}" class="dt-side-nav__link" title="">
                                        <i class="icon icon-components icon-fw icon-lg"></i>
                                        <span class="dt-side-nav__text"> Business category</span>
                                    </a>
                                </li>


                                <li
                                    class="dt-side-nav__item {{ (request()->segment(2) == 'checklist') ? 'selected' : '' }}">
                                    <a href="{{route('checklist.index')}}" class="dt-side-nav__link" title="Modern">
                                        <i class="icon icon-datatable icon-fw icon-lg"></i>
                                        <span class="dt-side-nav__text">Checklist</span>
                                    </a>
                                </li>
                            </ul>
                            <!-- /sub-menu -->
