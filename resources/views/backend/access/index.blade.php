                                ...
                                <table class="table table-hover mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$role->created_at}}</td>
                                          <td><ul class="dt-list dt-list-cm-0">
                                            <!-- List Item -->
                                            ...
                                            <!-- List Item -->
                                            <li class="dt-list__item">
                                              <a class="text-light-gray" href="javascript:void(0)"  data-toggle="modal" data-target="#permissionModal{{$role->id}}">
                                     ...
                                     <div class="btn-group dropdown mr-2 mb-2 d-none">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            {{-- <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" data-target="#permissionModal{{$role->id}}">Assign Permissions</a> --}}
                                        </div>
                                        <!-- /dropdown menu -->
...
<div class="modal fade" id="createNewRoleModal" tabindex="-1" role="dialog" aria-labelledby="model-3" aria-hidden="true" style="display: none;">
            ...
            <div class="modal-body">
                <form method="post" action="{{route('role.add')}}">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" name="name" required placeholder="Enter role name" aria-label="Enter role name">
...
<div class="modal fade" id="createNewPermissionModal" tabindex="-1" role="dialog" aria-labelledby="model-3" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-centered" role="document">
...
<!-- Modal -->
@foreach($roles as $role)
<div class="modal fade" id="permissionModal{{$role->id}}" tabindex="-1" role="dialog" aria-labelledby="model-3" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
